...
const Timeline = () => {
  ...
  const timelineEvents = [
    ...
    { icon: "💌", title: "We talked", desc: "We started talking and the connection was instant (lets just keep that bond forever" },
    { icon: "🎵", title: "I Enjoyed talking to you", desc: "You have an amazing music taste, by the way" },
    { icon: "✨", title: "To be continued...", desc: "Our story is just beginning and a long journey awaits" }
  ];

...
const AnimatedBackground = () => {
  ...
  const randomTexts = ['Love', 'Joy', 'XOXO', '❤️', '💖', 'Kiss' , 'love you'];
...
const Qualities = () => {
  ...
  const qualities = [
    { icon: "🌞", title: "Your lovely Smile", desc: "Makes my day shine" },
    { icon: "😂", title: "Your Humor", desc: "Laughs at my bad jokes(makes me happy)" },
    { icon: "🎵", title: "Your Sweet Voice", desc: "Perfect singing buddy" },
    { icon: "🥺", title: "Your Goodness", desc: "Your kind heart melts mine (hopefully you stay kind to me)" },
    { icon: "✨", title: "Your Eyes", desc: "They say eyes dont lie and i feel it" },
    { icon: "💫", title: "Everything About You", desc: "Just perfect as you are(my love)" },
  ];

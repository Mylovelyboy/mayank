...
const WhyMe = () => {
  ...
  const whyMeReasons = [
    { icon: "🫂", title: "I'm all yours senorita", desc: "Best partner you could have!" },
    { icon: "🎵", title: "My music taste is best", desc: "I can sing all your favorite songs" },
    { icon: "🤗", title: "I'm never gonna stop irritating you", desc: "i will always be the reason for your headache" },
    { icon: "💝", title: "I Will Take Care of You", desc: "Like always and make you pancakes " }
  ];
